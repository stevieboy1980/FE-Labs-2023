...
var streetAddress = "1234 E Main St."
...
//  ↓ YOUR CODE HERE ↓
console.log("My fat ass bought a candy bar so my total has changed to " + (costOfGroceries + 2.15)) ;

    console.log('Fix a Birth Certificate:')
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
middleInitial = 'D';
console.log ("The middle initial on the birth certificate has changed to " + middleInitial); 
...
//  ↓ YOUR CODE HERE ↓
var fullName = firstName + middleInitial + "Young"
